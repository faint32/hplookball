 ...
 * */
public class PostOrderActivity extends HupuBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		methodId = in.getIntExtra("method_id", HuPuRes.REQ_METHOD_GET_RECHARGE);
		if (methodId != HuPuRes.REQ_METHOD_GET_RECHARGE) {
