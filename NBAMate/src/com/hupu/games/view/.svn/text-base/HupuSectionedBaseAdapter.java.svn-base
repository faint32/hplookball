...
import com.hupu.games.view.HupuPinnedHeaderListView.PinnedSectionedHeaderAdapter;
...
public abstract class HupuSectionedBaseAdapter extends BaseAdapter implements PinnedSectionedHeaderAdapter {
    ...
    public HupuSectionedBaseAdapter() {
        super();
