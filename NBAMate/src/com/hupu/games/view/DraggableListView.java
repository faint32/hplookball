...
public class DraggableListView extends ListView {
	...
	public static int mFirstDragPos; // where was the dragged item originally
	...
	private void doExpansion() {
		...
		View first = getChildAt(mDragPos - getFirstVisiblePosition());
		Log.e("papa", "差值="+(mDragPos - getFirstVisiblePosition()));
		...
		for (int i = 0;; i++) {
			...
			/*//设置所移动的view 隐藏
			ViewGroup.LayoutParams firstParams = getChildAt(mFirstDragPos).getLayoutParams();
			firstParams.height = 0;
            getChildAt(mFirstDragPos).setLayoutParams(firstParams);
            getChildAt(mFirstDragPos).setVisibility(View.INVISIBLE);*/
