...
public class PayDialog extends Dialog {
    ...
    String[] chanelArr;
	public PayDialog(Context context, PayCallBack click,
			OrderPacEntity entity) {
	...
	private void initView() {
		...
		txt_pay.setText(entity.recharge+"元兑换"+entity.total+"金豆");
	...
	private class RadiobuttonListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			mClick.onPayListener(PayDialog.this,entity,chanelArr[tag]);
		}
	}
}
